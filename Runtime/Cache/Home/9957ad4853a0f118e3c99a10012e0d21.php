...
<title>Home</title>
<!-- core CSS -->
<link href="/TP/shop/Public/css/bootstrap.min.css" rel="stylesheet">
<link href="/TP/shop/Public/css/font-awesome.min.css" rel="stylesheet">
<link href="/TP/shop/Public/css/animate.min.css" rel="stylesheet"> 
<link href="/TP/shop/Public/css/prettyPhoto.css" rel="stylesheet">
<link href="/TP/shop/Public/css/styles.css" rel="stylesheet"> 
<!--[if lt IE 9]>
<script src="js/html5shiv.js"></script>
<script src="js/respond.min.js"></script>
<![endif]-->       
<link rel="shortcut icon" href="/TP/shop/Public/images/ico/favicon.ico"> 
</head> 
	...
	<nav id="main-nav" class="navbar navbar-default navbar-fixed-top" role="banner">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/TP/shop"><img src="/TP/shop/Public/images/logo.png" alt="logo"></a>
			</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6 wow fadeInLeft">
			  <img class="img-responsive" src="/TP/shop/Public/images/about.png" alt="">
			</div>
		...
		<div class="row text-center">
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
					<div class="team-img">
						<img class="img-responsive" src="/TP/shop/Public/images/team/01.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>Micky Deo</h3>
						<span>Founder</span> 
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
					<div class="team-img">
						<img class="img-responsive" src="/TP/shop/Public/images/team/02.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>Mike Timobbs</h3>
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
					<div class="team-img">
						<img class="img-responsive" src="/TP/shop/Public/images/team/03.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>Remo Silvaus</h3>
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
					<div class="team-img">
						<img class="img-responsive" src="/TP/shop/Public/images/team/04.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>Niscal Deon</h3>
						<span>Massager</span> 
		...
		<div class="portfolio-items">
			<div class="portfolio-item designing">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/TP/shop/Public/images/portfolio/01.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/TP/shop/Public/images/portfolio/01.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item mobile development">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/TP/shop/Public/images/portfolio/02.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/TP/shop/Public/images/portfolio/02.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item designing">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/TP/shop/Public/images/portfolio/03.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/TP/shop/Public/images/portfolio/03.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item mobile">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/TP/shop/Public/images/portfolio/04.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/TP/shop/Public/images/portfolio/04.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item designing development">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/TP/shop/Public/images/portfolio/05.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/TP/shop/Public/images/portfolio/05.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item mobile">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/TP/shop/Public/images/portfolio/06.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/TP/shop/Public/images/portfolio/06.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item designing development">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/TP/shop/Public/images/portfolio/07.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/TP/shop/Public/images/portfolio/07.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item mobile">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/TP/shop/Public/images/portfolio/08.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/TP/shop/Public/images/portfolio/08.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
		</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="single-testimonial animate_fade_in" style="opacity: 1; right: 0px;">
						...
						<div class="row">
							<div class="col-xs-3">
								<img src="/TP/shop/Public/images/pic1.jpg" alt="client">
							</div>
				...
				<div class="col-md-4">
					<div class="single-testimonial animate_fade_in" style="opacity: 1; right: 0px;">
						...
						<div class="row">
							<div class="col-xs-3">
								<img src="/TP/shop/Public/images/pic2.jpg" alt="client">
							</div>
							<div class="col-xs-9 half-gutter">
								<h5>John Bond</h5>
								<h6>Lorem Ipsuis simply</h6>
			  ...
			  <div class="col-sm-4 col-md-4">
				...
				<div class="col-sm-8 col-md-8">
					<div class="contact-form">
						...
						<form id="main-contact-form" name="contact-form" method="post" action="<?php echo U('Comment/addComment');?>">
...
<footer id="footer">
	<div class="container">
		<div class="row">
			<div class="col-sm-6">Copyright &copy; 2016.Company name All rights reserved.</div>
			<div class="col-sm-6">
				<ul class="social-icons">
					<li><a href="#"><i class="fa fa-facebook"></i></a></li>
					<li><a href="#"><i class="fa fa-twitter"></i></a></li>
...
<script src="/TP/shop/Public/js/jquery.js"></script>
<script src="/TP/shop/Public/js/bootstrap.min.js"></script> 
<script src="/TP/shop/Public/js/mousescroll.js"></script>
<script src="/TP/shop/Public/js/smoothscroll.js"></script>
<script src="/TP/shop/Public/js/jquery.prettyPhoto.js"></script>
<script src="/TP/shop/Public/js/jquery.isotope.min.js"></script>
<script src="/TP/shop/Public/js/jquery.inview.min.js"></script>
<script src="/TP/shop/Public/js/wow.min.js"></script>
<script src="/TP/shop/Public/js/custom-scripts.js"></script>
</body>
</html>